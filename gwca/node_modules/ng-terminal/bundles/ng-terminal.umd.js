(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('xterm'), require('xterm/lib/addons/fit/fit'), require('rxjs'), require('angular-resizable-element'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ng-terminal', ['exports', '@angular/core', 'xterm', 'xterm/lib/addons/fit/fit', 'rxjs', 'angular-resizable-element', '@angular/common'], factory) :
    (global = global || self, factory(global['ng-terminal'] = {}, global.ng.core, global.xterm, global.fit$1, global.rxjs, global.angularResizableElement, global.ng.common));
}(this, function (exports, core, xterm, fit$1, rxjs, angularResizableElement, common) { 'use strict';
    ...
    var NgTerminalService = /** @class */ (function () {
        ...
        /** @nocollapse */ NgTerminalService.ngInjectableDef = core.defineInjectable({ factory: function NgTerminalService_Factory() { return new NgTerminalService(); }, token: NgTerminalService, providedIn: "root" });
    ...
    var NgTerminalComponent = /** @class */ (function () {
         ...
         */
        function () {
            xterm.Terminal.applyAddon(fit$1); // Apply the `fit` addon   
